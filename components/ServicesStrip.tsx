...
export default function ServicesStrip() {
  return (
    <div className="relative w-full bg-transparent py-8 md:py-12 -mt-12 md:-mt-16 z-20">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="flex justify-center">
          <div className="glass-overlay border border-[#C9A24A]/20 rounded-2xl backdrop-blur-xl" style={{
            background: 'rgba(11, 42, 53, 0.6)',
          }}>

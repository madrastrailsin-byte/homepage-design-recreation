...
export default function Navigation() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#071B24]/40 backdrop-blur-xl border-b border-[#C9A24A]/10">
      <div className="max-w-7xl mx-auto px-6 md:px-8 py-3 md:py-4 flex items-center justify-between">
        {/* Logo */}
        ...
        <div className="hidden md:flex items-center gap-9 xl:gap-11">
          <a href="#" className="text-[#E8E8E8] text-xs font-light hover:text-[#C9A24A] transition duration-300">Destinations</a>
        ...
        <div className="flex items-center gap-4">
          <button className="btn-gold hidden md:block text-xs font-light tracking-wide py-2">PLAN YOUR JOURNEY →</button>
          <button

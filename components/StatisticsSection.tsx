...
export default function StatisticsSection() {
  ...
  return (
    <section className="mt-scroll-statistics mt-scene03-section w-full overflow-hidden bg-[var(--mt-canvas)]">
      <div className="mt-scene03-stage mx-auto w-full">
        <div className="mt-scene03-grid grid min-h-0 grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <div className="mt-scene03-copy-column relative z-20 bg-[var(--mt-canvas)]">
            <Scene03CopyColumn
              eyebrow={eyebrow}
              headline={headline}

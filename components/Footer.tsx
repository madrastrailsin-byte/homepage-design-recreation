          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            ...
            >
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                {/* Instagram */}
                <a href="#" className="w-10 h-10 rounded-full border border-[#D4AF37]/50 flex items-center justify-center text-[#D4AF37] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#D4AF37] hover:text-[#03191D] hover:shadow-[0_10px_24px_rgba(212,175,55,0.14)]">

...
>
            ...
            >
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                {/* Instagram */}
                <a href="https://www.instagram.com/madrastrails/" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/MadrasTrails/" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@madrastrails" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>

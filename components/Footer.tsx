...
>
            ...
            >
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                {/* Instagram */}
                <a href="https://www.instagram.com/madrastrails/" aria-label="MadrasTrails on Instagram" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/MadrasTrails/" aria-label="MadrasTrails on Facebook" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>
                ...
                {/* YouTube */}
                <a href="https://www.youtube.com/@madrastrails" aria-label="MadrasTrails on YouTube" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/917891876918" aria-label="Chat with MadrasTrails on WhatsApp" target="_blank" rel="noopener noreferrer" className={socialLinkClass}>

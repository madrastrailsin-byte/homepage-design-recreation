...
export default function Footer() {
  return (
    <footer className="border-t border-[#D4AF37]/10 bg-[#03191D]">
      {/* Top Band - Three Parts Side by Side */}
      <section className="py-12 md:py-16 bg-[#020F12]/34 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            ...
            >
              ...
              <div className="flex gap-4 justify-center md:justify-end">
                {/* Instagram */}
                <a href="#" className="w-10 h-10 rounded-full border border-[#D4AF37]/50 flex items-center justify-center text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#03191D] transition">
      ...
      <div className="py-5 md:py-6 border-t border-[#D4AF37]/10">
        <div className="max-w-7xl mx-auto px-6 md:px-8">

    ...
    <section className="bg-[#0D1117] section-spacing">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-4xl md:text-5xl font-serif text-white mb-4">Handpicked Experiences</h2>
          <h3 className="text-4xl md:text-5xl font-serif text-white mb-8">Just for You</h3>
          <p className="text-[#D4AF37]/80 max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {experiences.map((exp, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative h-96 rounded-3xl overflow-hidden card-luxury cursor-pointer"
            >
              {/* Background Image */}
              <div
              ...
              <div className="relative h-full flex flex-col justify-between p-6">
                ...
                <div className="flex justify-end">
                  <div className="w-10 h-10 rounded-full border-2 border-[#D4AF37]" />
                </div>

                {/* Bottom Content */}
                <div>
                  <h3 className="text-2xl font-serif text-white mb-2">{exp.title}</h3>
                  <p className="text-[#D4AF37] text-sm mb-4">{exp.description}</p>
